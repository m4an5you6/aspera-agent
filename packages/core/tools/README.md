...
Source and built copies of this package share one scheduler key within a process, so the agent loop and PTC dispatcher can access the mounted tool runtime through either entry.
