 ...
 * so surrounding chrome can match the app theme. `system` only when the
 * preference is `system`; a fixed preference (including registered theme
 * ids) publishes its resolved scheme.
 */
